...
Since we now have spatial described estimations of pre-hibernation body fat and the duration of the hibernation period it's time to integrate the energetic components of the analysis. To begin we run a run the dynamic energetic model across a combination of potential hibernacula conditions.
