...
```
Now that we have found a scaling relationship between the bat mass and body fat we can begin to look at the larger spatial analysis portion of the project. In this next script we will use collected datasets for the duration of the winter hibernation period, and body mass to create spatially continuous estimates for each.
